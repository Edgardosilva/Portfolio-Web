...
const CategoryNav = ({ text, id }) => {
    return (
 
        <a href={id} className="group relative inline-block overflow-hidden rounded  bg-transparent  px-12 py-3 text-lg font-medium text-slate-300 hover:text-cyan-500 focus:outline-none">
